...
public plugin_init(){
	register_item("Rainbow Hud", "handleRainbow", "shopDR_colors.amxx", 15000, RAINBOW_ID);
...
public handleRainbow(id){
	...
	CC_SendMessage(0, "&x01Jucatorul &x04%s &x01a cumparat &x07Rainbow Hud &x01din shop pentru &x0415.000 &x01de credite!", szName);
