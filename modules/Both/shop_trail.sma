...
new gl_sprite_name[NUM_SPRITES][] = {
	"sprites/new/bio.spr",
	"sprites/new/chain.spr",
	"sprites/new/Half-Life.spr",
	"sprites/new/lighting.spr",
	"sprites/new/love.spr",
	"sprites/new/minecraft.spr",
	"sprites/new/snow_white.spr",
	"sprites/new/tok.spr",
	"sprites/new/tok1.spr",
	"sprites/new1/blue-green.spr",
	"sprites/new1/blue-pink.spr",
	"sprites/zbeam2.spr",
	"sprites/new1/Dota2.spr",
	"sprites/new1/icecream.spr",
	"sprites/new1/pink-jacket.spr",
	"sprites/new1/yellow-green.spr",
}
...
public SayCmd(id, level, cid) {
	...
	if (equali(args, "trail", 5)) {
		...
		if(!inventory_get_item(id, TRAIL_ID)){
			client_print(id, print_chat, "You don't have acces to trail.")
			return PLUGIN_HANDLED;
		}
