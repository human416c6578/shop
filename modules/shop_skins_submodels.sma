...
new g_Knives[KNIFE_NUM][eSkin] = {
    {100, "Default",            0, 0, false},
    {101, "Knife Abstract",     1, 2500, false},
    {102, "Knife Among Us",     2, 2500, false},
    {103, "Knife Arc Pink",     3, 2500, false},
    {104, "Knife Cold Cerf",    4, 2500, false},
    {105, "Knife Color",        5, 2500, false},
    {106, "Knife Cosmic Ohmy",  6, 2500, false},
    {107, "Knife Faded",        7, 2500, false},
    {108, "Knife fekete",       8, 2500, false},
    {109, "Knife frozen",       9, 2500, false},
    {110, "Knife Ghost Blue",   10, 2500, false},
    {111, "Knife Ghost Red",    11, 2500, false},
    {112, "Knife Lightning",    12, 2500, false},
    {113, "Knife Linkin Park",  13, 2500, false},
    {114, "Knife Nexus",        14, 2500, false},
    {115, "Knife Night",        15, 2500, false},
    {116, "Knife Nightraid",    16, 2500, false},
    {117, "Knife Space Ohmy",   17, 2500, false},
    {118, "Knife Sponge Bob",   18, 2500, false},
    {119, "Knife Steel",        19, 2500, false},
    {120, "Knife Thug Cat",     20, 2500, false},
    {121, "Knife White Duck",   21, 2500, false},
    {122, "Knife Yum",          22, 2500, false},
    // VIP skins (from here down)
    {123, "Knife Ahegao",       23, 2500, true},
    {124, "Knife Black",        24, 2500, true},
    {125, "Knife Black White",  25, 2500, true},
    {126, "Knife Blood",        26, 2500, true},
    {127, "Knife Fire",         27, 2500, true},
    {128, "Knife Fire Flower",  28, 2500, true},
    {129, "Knife Galaxy",       29, 2500, true},
    {130, "Knife Goku",         30, 2500, true},
    {131, "Knife Gold",         31, 2500, true},
    {132, "Knife Grizzly",      32, 2500, true},
	{133, "Knife Howl",         33, 2500, true},
    {134, "Knife Icephoenix",   34, 2500, true},
    {135, "Knife Iridescent",   35, 2500, true},
    {136, "Knife Joker",        36, 2500, true},
    {137, "Knife King",         37, 2500, true},
    {138, "Knife Moon",         38, 2500, true},
    {139, "Knife Neo-Noir",     39, 2500, true},
    {140, "Knife Purple",       40, 2500, true},
    {141, "Knife Sakura",       41, 2500, true},
    {142, "Knife Shred",        42, 2500, true},
    {143, "Knife Storm",        43, 2500, true},
    {144, "Knife Venom",        44, 2500, true}
};

new g_Butchers[BUTCHER_NUM][eSkin] = {
    {150, "Default",            0, 0, false},
    {151, "Butcher Black Wolf", 1, 2500, false},
    {152, "Butcher Blood",      2, 2500, false},
    {153, "Butcher Carbon",     3, 2500, false},
    {154, "Butcher Fade",       4, 2500, false},
    {155, "Butcher Lion",       5, 2500, false},
    {156, "Butcher Nezuko",     6, 2500, false},
    {157, "Butcher Rainbow",    7, 2500, false},
    {158, "Butcher Red Ghost",  8, 2500, false},
    {159, "Butcher Rias",       9, 2500, false},
    // VIP skins (from here down)
    {160, "Butcher Blood Khalifa", 10, 2500, true},
    {161, "Butcher Boris",      11, 2500, true},
    {162, "Butcher Gojo",       12, 2500, true},
    {163, "Butcher Hyperbeast", 13, 2500, true},
    {164, "Butcher Iridescent", 14, 2500, true},
    {165, "Butcher Lion blade", 15, 2500, true},
    {166, "Butcher Neo-Noir",   16, 2500, true},
    {167, "Butcher Xiao",       17, 2500, true}
};
...
new g_Usps[USP_NUM][eSkin]={
    {200, "Default",            0, 0, false},
    {201, "Abstract",           1, 2500, false},
    {202, "Blue Print",         2, 2500, false},
    {203, "Carbon",             3, 2500, false},
    {204, "Dark Flower",        4, 2500, false},
    {205, "Dark Red",           5, 2500, false},
    {206, "Dolomit",            6, 2500, false},
    {207, "Fade",               7, 2500, false},
    {208, "Fire",               8, 2500, false},
    {209, "Night Wolf Green",   9, 2500, false},
    {210, "Nightfire",          10, 2500, false},
    {211, "Nightraid",          11, 2500, false},
    {212, "Orion",              12, 2500, false},
    {213, "Pac-Man",            13, 2500, false},
    {214, "Strong Blue",        14, 2500, false},
    {215, "Water",              15, 2500, false},
    // VIP skins (from here down)
    {216, "Abstract",           16, 2500, true},
    {217, "Abstract Blue",      17, 2500, true},
    {218, "Black",              18, 2500, true},
    {219, "Blue",               19, 2500, true},
    {220, "Bright",             20, 2500, true},
    {221, "Cortex",             21, 2500, true},
    {222, "Fire Flower",        22, 2500, true},
    {223, "Flashback",          23, 2500, true},
    {224, "Iridescent",         24, 2500, true},
    {225, "Lightning Monster",  25, 2500, true},
    {226, "Neo-Noir",           26, 2500, true},
    {227, "Night Wolf",         27, 2500, true},
    {228, "Sakura",             28, 2500, true},
    {229, "Ticket To Hell",     29, 2500, true},
    {230, "Xiao",               30, 2500, true},
    {231, "Xtreme",             31, 2500, true}
};
