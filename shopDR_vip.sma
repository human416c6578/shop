...
public plugin_init(){
	...
	register_item("Tag 1 Day", "handleTag1", "shopDR_vip.amxx", 1000);
	register_item("Tag 30 Day", "handleTag30", "shopDR_vip.amxx", 15000);
	register_item("Vip 1 Day", "handleVip1", "shopDR_vip.amxx", 2500);
	register_item("Vip 30 Day", "handleVip30", "shopDR_vip.amxx", 25000);
